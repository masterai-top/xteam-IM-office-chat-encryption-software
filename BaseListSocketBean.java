 ...
 * 描    述：
 */
public class BaseListSocketBean<T extends BaseSocketBean> extends BaseSocketBean {
    ...
    public BaseListSocketBean(HashMap<String, Object> receiveProtocol, ReceiveProtocol preseq, String key, Class clazz) {
        mKey = key;
        mClazz = clazz;
